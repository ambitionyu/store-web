    ...
    routes: [
        ...
        },
        {
            ...
            children:[
                {
                    path:"/control/user",
                    component:()=>import("@/routes/User/UserControl")
                },{
                    path:"/control/foodClass",
                    component:()=>import("@/routes/foodClass/foodClass")
                },{
                    path:"/control/canteen",
                    component:()=>import("@/routes/Views/Canteen")
                },{
                    path:"/control/supplier",
                    component:()=>import("@/routes/Supplier/SupplierControl")
                },{
                    path:"/control/order",
                    component:()=>import("@/routes/Views/Order")
                },{
                    path:"/control/require",
                    component:()=>import("@/routes/Views/Require")
                },{
                    path:"/control/store",
                    component:()=>import("@/routes/Views/Store")
                },
            ],
        },
        {
